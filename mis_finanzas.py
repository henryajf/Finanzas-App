...
</style>""", unsafe_allow_html=True)── CONEXION ──
@st.cache_resource
def get_gspread():
...
""", unsafe_allow_html=True)st.markdown(’<div class="wrap">’, unsafe_allow_html=True)
...
""", unsafe_allow_html=True)── BOTTOM TAB BAR (hidden columns for state, visible bar at bottom) ──
