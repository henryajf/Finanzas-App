...
.wrap{{max-width:980px;margin:0 auto;padding:0 16px 100px;}}

/* Oculta las columnas de navegación fantasma sin desactivar su funcionalidad JS */
...
@media(max-width:700px){{
  ...
  /* La 3ra tarjeta (Balance y Cubierto) ocupa el ancho completo */
...
with _hc1:
    # Estos contenedores seguirán renderizando los botones subyacentes, pero CSS ocultará la fila visual
